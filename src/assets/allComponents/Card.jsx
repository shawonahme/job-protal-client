...
const Card = ({ jobs }) => {
    const { _id, title, hr_name, company_logo, hr_email, status, responsibilities, requirements, company, description, salaryRange, category, applicationDeadline, jobType, location } = jobs
    return (
        <div>
            <div className="card bg-base-100 flex flex-col h-full  p-4 shadow-xl">
                ...
                <div className="card-actions justify-end ">
                    <Link to={`/jobs/${_id}`} className=" py-2 px-4  bg-blue-600 text-white rounded-md ">See Details</Link>
                </div>
            </div>
